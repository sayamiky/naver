...
?>
<input type="hidden" value="<?php echo $record['idcust']?>" name="idcust">
<table class="table table-bordered">
  <tr><td width="130">Nama Customer</td>
        <td>
        <div>
       <input type="text" name="namacust" placeholder="Nama Customer" class="form-control" value="<?php echo $record['namacust']?>">
        </div>
       </td>
  </tr>
  <tr><td width="130">No Telp.</td>
        <td>
        <div>
       <input type="text" name="tlp" placeholder="No Telp" class="form-control" value="<?php echo $record['tlp']?>">
        </div>
       </td>
  </tr>
